angular.module('apf.util').factory('ChartsDataMixin', ['$timeout', '$q', function chartDataMixinFactory ($timeout, $q) {
  'use strict';
  ...
  var getSparklineData = function (data, dataName, incrementSecs) {
    ...
    if (data) {
      ...
      if (data.dates && data.dates.length > 0) {
        ...
        // Use fake dates
        today = new Date();
        for (d = data.data.length - 1; d >= 0; d--) {
  ...
  return {
    ...
    dashboardHeatmapChartHeight:    260,
