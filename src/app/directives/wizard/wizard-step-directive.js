angular.module('apf.wizard').directive('apfWizardStep', function () {
  'use strict';
  return {
    restrict: 'A',
    replace: true,
    ...
    require: '^apf-wizard',
    templateUrl: 'src/app/directives/wizard/wizard-step.html',
    controller: function ($scope, $timeout) {
      ...
      $scope.$watch('currentStep', function (step) {
        ...
        if ($scope.selectedStep && $scope.selectedStep.wzTitle !== $scope.currentStep) {
