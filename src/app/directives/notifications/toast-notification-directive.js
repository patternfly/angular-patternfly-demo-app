angular.module( 'apf.appModule' ).directive('apfToastNotification', ['apf.notificationService',
  function (notificationService) {
    ...
    return {
      ...
      restrict: 'A',
      templateUrl: 'src/app/directives/notifications/toast-notification.html',
