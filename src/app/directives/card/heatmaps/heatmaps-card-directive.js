angular.module( 'apf.card' ).directive('heatmapsCard', ['ChartsDataMixin' ,function (chartsDataMixin) {
  'use strict';
  return {
    restrict: 'A',
    scope: {
    ...
    templateUrl: 'src/app/directives/card/heatmaps/heatmaps-card.html',
