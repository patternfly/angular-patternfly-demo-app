angular.module('apf.navigation').directive('apfVerticalNavigation', ['$location', '$rootScope', '$window', '$document', '$timeout',
  function (location, rootScope, $window, $document, $timeout) {
    ...
    return {
      ...
      replace: true,
      templateUrl: 'src/app/directives/navigation/vertical-navigation.html',
      transclude: true,
