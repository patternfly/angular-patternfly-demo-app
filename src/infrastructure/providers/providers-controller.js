angular.module('apf.infrastructure.providersModule').controller('infrastructure.providersController',
  ...
  function ($rootScope, $scope, $resource, $location, chartsDataMixin, listUtils, pfViewUtils, $routeParams, $modal) {
    ...
    $resource('mock_data/infrastructure/providers/status/all').get(function (data) {
      ...
      $scope.allProviders.forEach(function (provider) {
        ...
        if (provider.providerType === 'vmware') {
          ...
          provider.providerImg = "bower_components/patternfly/dist/img/Openshift-Logo-Notext.svg";
        } else if (provider.providerType === 'kubernetes') {
          provider.providerImg = "bower_components/patternfly/dist/img/kubernetes.svg";
        } else if (provider.providerType === 'atomic') {
          provider.providerImg = "bower_components/patternfly/dist/img/RH_Atomic-Logo-NoText.svg";
        } else {
