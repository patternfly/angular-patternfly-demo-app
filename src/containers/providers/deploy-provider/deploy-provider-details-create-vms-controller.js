angular.module('apf.containers.providersModule').controller('containers.deployProviderDetailsCreateVMsController',
  ...
  function ($rootScope, $scope, $timeout, $document) {
    ...
    $scope.reviewTemplate = "src/containers/providers/deploy-provider/deploy-provider-master-nodes-review-create-vms.html";
