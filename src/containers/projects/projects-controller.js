angular.module('apf.containers.projectsModule').controller('containers.projectsController',
  ...
  function ($rootScope, $scope, $resource, $location, chartsDataMixin, listUtils, pfViewUtils) {
    ...
    $resource('mock_data/containers/projects/all').get(function (data) {
      ...
      $scope.allProjects.forEach(function (project) {
        ...
        if (project.providerType === 'openshift') {
          project.providerImg = "bower_components/patternfly/dist/img/Openshift-Logo-Notext.svg";
        } else if (project.providerType === 'kubernetes') {
          project.providerImg = "bower_components/patternfly/dist/img/kubernetes.svg";
        } else if (project.providerType === 'atomic') {
          project.providerImg = "bower_components/patternfly/dist/img/RH_Atomic-Logo-NoText.svg";
        } else {
          project.providerImg = '';
        }
