angular.module('apf.containers.podsModule').controller('containers.podController', ['$scope', 'ChartsDataMixin', 'DashboardUtils', '$translate', '$resource', '$routeParams',
  function ($scope, chartsDataMixin, $translate, dashboardUtils, $resource, $routeParams ) {
    ...
    $resource('mock_data/containers/pods/utilization').get(function (response) {
...
//      filterConfig: $scope.filterConfig,
    ...
    $resource('mock_data/containers/pods/containers').get(function (data) {
